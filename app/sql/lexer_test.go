	...
	testCases := []testCaseLexer{
...

		{
			...
			want: []sql.Token{
				...
				{Type: sql.STRING, Value: "column2"},
				{Type: sql.EQ, Value: "="},
				{Type: sql.INT, Value: "20"},
				{Type: sql.OR, Value: "OR"},
				{Type: sql.STRING, Value: "column3"},
				{Type: sql.EQ, Value: "="},
...

		{
			...
			want: []sql.Token{
				...
				{Type: sql.AND, Value: "AND"},
				{Type: sql.STRING, Value: "column4"},
				{Type: sql.GTE, Value: ">="},
				{Type: sql.FLOAT, Value: "40.124"},
				{Type: sql.CLOSE_PAREN, Value: ")"},
				{Type: sql.OR, Value: "OR"},
				{Type: sql.OPEN_PAREN, Value: "("},
				{Type: sql.STRING, Value: "column5"},
				{Type: sql.LT, Value: "<"},
				{Type: sql.FLOAT, Value: "50.10"},
				{Type: sql.AND, Value: "AND"},
				{Type: sql.STRING, Value: "column6"},
				{Type: sql.LTE, Value: "<="},
